		  ...
		  <div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  ...
			  <ul class="nav navbar-nav navbar-right">
				<li><a href="/vol-web/ville/add/?lang=en">En</a></li>
				<li><a href="/vol-web/ville/add/?lang=fr">Fr</a></li>
			  </ul>
			</div>
		  </div>
		</nav>
		<div class="jumbotron">
			<h2><spring:message code="ville.edit.form"/></h2> 
		</div>
		<fieldset>
			...
			<form:form modelAttribute="ville" action="save" method="post">
				...
				<div class="form-group">
					<form:label path="nom"><spring:message code="ville.edit.nom"/>:</form:label> <form:input type="text" class="form-control" path="nom"/>
				...
				<a href="<c:url value="/ville/cancel"/>" class="btn btn-warning arondi"><span class="glyphicon glyphicon-remove"></span></a>
			</form:form>
		</fieldset>
	</div>
